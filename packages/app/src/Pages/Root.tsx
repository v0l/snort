...
import { Link, Outlet, Route, RouteObject, useNavigate, useParams } from "react-router-dom";
...
const GlobalTab = () => {
  ...
  return (
    <>
      {globalRelaySelector()}
      {relay && <Timeline subject={subject} postsOnly={false} method={"TIME_RANGE"} window={600} relay={relay.url} />}
    </>
  );
};
