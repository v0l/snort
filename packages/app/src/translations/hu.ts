export default {
  ...
  "6ewQqw": "Lájkok ({n})",
  "6tUqAb":
    "Egy publikus / privát kulcs generálása. A privát kulcsot senkivel se oszd meg, mivel ez a te jelszavadként funkcionál. Ha elhagyod, nem lehet visszaállítani. Tartsd biztonságban!",
  "7+Domh": "Bejegyzések",
  "7hp70g": "NIP-05",
  ...
  EnCOBJ: "Vásárlás",
  Eqjl5K:
    "Csak a Snort és a mi integrációs partnerünk azonosítója ad színes domain nevet, de azonosításra szabadon használhatod más szolgáltatók szolgáltatásait is.",
  ...
  VlJkSk: "{n} némított",
  VnXp8Z: "Avatar",
  "VtPV/B": "Bejelentkezés kiterjesztéssel (NIP-07)",
  ...
  k2veDA: "Írás",
  k7sKNy:
    "A mi saját NIP-05 azonosítási szolgáltatásunk, amelynek a használatával ennek az oldalnak a fejlesztését segítheted és ezzel egy speciális kitüntetést is szerezhetsz!",
  lCILNz: "Vásárlás",
  "lD3+8a": "Fizetem",
  ...
  mH91FY:
    "Minden közreműködő az adományok és a NIP-05 rendelések egy bizonyos százalékát kapja. A megosztott összegeket alább láthatja",
  ...
  nwZXeh: "{n} tiltott",
  o6Uy3d:
    "Csak a titkos privát kulccsal lehetséges bármely közzététel (események aláírása), minden más csak olvasható módban kerül naplózásra.",
  "o7e+nJ": "{n} követők",
