export default {
  ...
  "/JE/X+": "アカウントサポート",
  "/RD0e2":
    "Nostrはデジタル署名技術を使って投稿の改竄防止を図り、多数のリレーに安全に複製してコンテンツの冗長ストレージを提供しています。",
  ...
  "6ewQqw": "スキ ({n})",
  "6tUqAb":
    "公開鍵/秘密鍵のペアを生成します。秘密鍵は誰とも共有しないでください。これはパスワードとして機能します。一度紛失すると、「リセット」も回復もできません。安全に保管してください！",
  "7+Domh": "投稿",
  "7hp70g": "NIP-05",
  ...
  INSqIz: "Twitterユーザー名",
  "IUZC+0":
    "このため、あなたが作成した投稿を誰も変更できず、誰でも簡単にあなたが作成した投稿であることを確認できます。",
  JCIgkj: "ユーザー名",
  JHEHCk: "Zap ({n})",
  JkLHGw: "ウェブサイト",
  K3r6DQ: "削除",
  ...
  jCA7Cw: "Snortでプレビュー",
  jfV8Wr: "戻る",
  juhqvW: "ブラウザ拡張機能でログインのセキュリティを向上",
  jvo0vs: "保存",
  k2veDA: "ライト",
  k7sKNy:
  ...
  lnaT9F: "{n}フォロー中",
  lvlPhZ: "インボイスを精算",
  mH91FY: "各貢献者は、全ての寄付とNIP-05の注文に対して一定の割合で報酬を受け取ります。その分配額は以下の通りです",
  mKAr6h: "全てフォロー",
  mKh2HS: "ファイル添付サービス",
  ...
  nwZXeh: "{n}ブロック",
  o6Uy3d: "公開（イベントへの署名）に使えるのは秘密鍵だけで、それ以外では読み取り専用モードでログを記録します。",
  "o7e+nJ": "{n}フォロワー",
  odFwjL: "フォローのみ",
  odhABf: "ログイン",
