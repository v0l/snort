/**
 * Client-side hydration entry point for SSR.
 * Reads SSR locale and messages from window.__SSR_LOCALE__ and window.__SSR_MESSAGES__
 * to ensure proper hydration with the server-rendered content.
 */
import "./index.css"
...
// Read SSR locale and messages from window (set by server during SSR)
const ssrLocale = (window as Window & { __SSR_LOCALE__?: string }).__SSR_LOCALE__
const ssrMessages = (window as Window & { __SSR_MESSAGES__?: Record<string, string> }).__SSR_MESSAGES__
...
root.render(
  <StrictMode>
    <IntlProvider locale={ssrLocale} messages={ssrMessages} defaultLocale="en">
